...
const OurTeam: React.FC = () => {
    return (
        <>
            <div className="py-8 md:py-14 flex flex-col md:flex-row gap-6 md:gap-0">
                <div className="w-full md:w-1/2 flex flex-nowrap justify-center items-center">
                    <div className="flex flex-col flex-nowrap justify-center items-center w-[min(425px,100%)] px-2.5" >
