...
const CaseStudy: React.FC<CaseStudyProps> = ({items, images}) => {
    return (
        <section className="pt-16 sx:pt-[67px] md:px-2 full:px-0" aria-labelledby="caseStudy">
            <div className="flex flex-wrap md:flex-nowrap p-4 w-[min(1200px,100%)] mx-auto gap-10 shadow-md">
                ...
                <div className="flex-[1_1_55%] md:flex-[]0_0_50%] h-full flex flex-col justify-start items-start gap-6 px-2 sx:px-0">
