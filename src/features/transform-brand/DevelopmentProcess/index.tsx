        ...
        <section className="pt-16 sx:pt-[67px] px-6 md:px-2 full:px-0" aria-labelledby="developmentProcess">
            ...
            <ol className="list-none">
                {items.steps.map((item, index) => (
                    <li key={index} className={`mb-8 flex items-center gap-4 process-step ${index % 2 === 0 ? "process-step-left ms-6" : "process-step-right me-6"}`}>
                        <div>
                            <h3 className="text-preset-6 text-grey-950 mb-2">{item.title}</h3>
