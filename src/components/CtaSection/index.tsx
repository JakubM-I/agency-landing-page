    ...
    return (
        <div className="py-16 sx:py-[67px] px-6 md:px-2 full:px-0">
            <div className="p-10 flex flex-col items-center justify-center gap-6 bg-red-400 rounded-2xl">
                ...
                <button className="bg-white py-2.5 px-3.5 rounded-2xl shadow-lg text-red-400 uppercase text-preset-8 font-bold text-center transition duration-450 easy-in-out md:cursor-pointer md:hover:-translate-y-1">
                    {items.btnText}
                </button>
            </div>
        </div>
