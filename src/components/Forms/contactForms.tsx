        ...
        <div className="">
            ...
            <form action="" className="p-5">
                <div className="flex flex-col mb-2 gap-1">
                    ...
                    <input type="text" required id="name" placeholder="Your full name" className="p-2 border border-grey-550 rounded-xl"/>
                </div>
                <div className="flex flex-col mb-2 gap-1">
                ...
                <div className="flex flex-col mb-2 gap-1">
                    ...
                    <select name="subject" id="subject" required className="p-2 border border-grey-550 rounded-xl">
